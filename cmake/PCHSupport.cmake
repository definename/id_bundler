...
#
#
# precompiled headers macro (can add pch to modules and tests)
# this macro must be called after any "add_definitions" commands, otherwise precompiled headers will not work
# Usage:
# add_precompiled_headers(${the_module} ${subfolder_for_precompiled_headers})
...
MACRO(ADD_NATIVE_PRECOMPILED_HEADER _targetName _input)
    ...
    if(CMAKE_GENERATOR MATCHES "^Visual.*$")
        ...
        SET(newProperties "${oldProps} /Yu\"${_input}\"")
...
macro(add_precompiled_headers the_target pch_path)
	set(pch_header "${CMAKE_CURRENT_SOURCE_DIR}/${pch_path}pch.h")

	if (PCHSupport_FOUND AND EXISTS "${pch_header}")
		if (CMAKE_GENERATOR MATCHES Visual)
			set(${the_target}_pch "${pch_path}pch.cpp")
			add_native_precompiled_header(${the_target} pch.h)
		elseif (CMAKE_GENERATOR MATCHES Xcode)
